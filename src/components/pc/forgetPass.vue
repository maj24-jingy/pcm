                    ...
                    <div class="login-form-box" style="top: 10px; margin-top: 22.8476px;">
                        <div class="form_wrap" style="display: block;">
                            ...
                            <el-tabs v-model="activeName">
                                ...
                                <el-tab-pane label="phone" name="first">
                                    <el-form>
                                      <el-form-item>
                                ...
                                <el-tab-pane label="email" name="second">
                                    <el-form>
                                      ...
                                      <span class="elformSpan" @click="$router.push({name: 'login'})">已有账号？去登录</span>
                                       <el-button type="success" plain @click="emLogin">Reset Password</el-button>
                                    </el-form>
                                </el-tab-pane>
                            </el-tabs>
    ...
    export default {
        ...
        methods: {
          ...
          async getCode() {
            ...
            async emLogin() {
                const res =await this.$http.post(`/getData/account?code=${this.eCode}&way=${this.way}`,this.form);
                console.log(res);
